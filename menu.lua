...
repeat
 ...
 KeybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(32, 3, 252)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
 ...
 Name.Text = "[<font color=\"rgb(32, 3, 252)\">Keybinds</font>]"
 ...
 Name_2.Text = "Silent Aim: <font color=\"rgb(32, 3, 252)\">[MB1]</font>"
 ...
 local function createWatermark()
    ...
    WatermarkFrame.BorderColor3 = Color3.fromRGB(32, 3, 252)
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'nero.<font color="rgb(32, 3, 252)">wtf</font> - uid: <font color="rgb(32, 3, 252)">' .. uid .. '</font> / fps: <font color="rgb(32, 3, 252)">' .. fpsValue .. '</font> / ping: <font color="rgb(32, 3, 252)">' .. ping .. '</font> / time: <font color="rgb(32, 3, 252)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    ...
    Watermark = createWatermark(),
       Colors = {
          libColor = Color3.fromRGB(32, 3, 252),
          riskyColor = Color3.fromRGB(255, 0, 0),
          FontColor = Color3.fromRGB(255, 255, 255),
          MainColor = Color3.fromRGB(14, 14, 14),
          AccentColor = Color3.fromRGB(32, 3, 252),
    ...
    for _, obj in pairs(menu:GetDescendants()) do
        if obj.Name:lower():find('name_esp') then
           obj.Text = '<font color="rgb(32, 3, 252)">' .. game.Players.LocalPlayer.Name .. '</font>'
        end
    end
    ...
    library:Create('UIListLayout', {Padding = UDim.new(0, 4); FillDirection = Enum.FillDirection.Vertical; SortOrder = Enum.SortOrder.LayoutOrder; Parent = library.NotificationArea})
        ...
        function library:Notify(Text, Time)
            ...
            local NotifyOuter = library:Create('Frame', {BorderColor3 = Color3.new(32, 3, 252); Position = UDim2.new(0, 100, 0, 10); Size = UDim2.new(0, 0, 0, YSize); ClipsDescendants = true; Transparency = 0; ZIndex = 100; Parent = library.NotificationArea})
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        local imageTweenStart = TweenService:Create(v, tweenInfo, {ImageColor3 = Color3.fromRGB(32, 3, 252)})
                        local textTweenStart = TweenService:Create(v.text, tweenInfo, {TextColor3 = Color3.fromRGB(32, 3, 252)})
                        ...
                        function group:addToggle(args)
                            ...
                            function toggle:addKeybind(args)
                                    ...
                                    if key.Name == "Unknown" or key.Name == "Unknown" then
                                        ...
                                        if args.gui then
                                            ...
                                            if args.type == "hold" then
                                                Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(32, 3, 252)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                            else
                                                if not Toggle then
                                                    Toggle = true
                                                    Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(32, 3, 252)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                    ...
                                                    Toggle = false
                                                    Name.Text = "<font color=\"rgb(125, 125, 125)\">" ..args.text.. ": /font>".." <font color=\"rgb(32, 3, 252)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                end
                                            end
                                        end
                                    end
                                ...
                                if args.gui then
                                    Name.Visible = true
                                    Name.Text = args.text..": <font color=\"rgb(32, 3, 252)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                end
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("nero.wtf/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                function library:refreshConfigs()
                    local tbl = {}
                    for i,v in next, listfiles("nero.wtf") do table.insert(tbl,v) end
